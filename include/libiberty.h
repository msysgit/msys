...
#if defined (__GNU_LIBRARY__ ) || defined (__linux__) || defined (__FreeBSD__) || defined (__OpenBSD__) || defined (__CYGWIN__) || defined (__MSYS__) || (defined (HAVE_DECL_BASENAME) && !HAVE_DECL_BASENAME)
