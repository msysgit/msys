...
/* Patterns with '/' that match file names to be excluded.  */
GLOBAL struct exclude *excluded_with_slash;

/* Patterns without '/' that match file names to be excluded.  */
GLOBAL struct exclude *excluded_without_slash;
...
int excluded_name PARAMS ((char const *));
